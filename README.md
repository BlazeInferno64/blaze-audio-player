...
Horizon Responsive Audio Player is a web app which is designed to make music easily accesible to anyone - anywhere while browsing, Please don't misuse this repository for HARASSING/SPAMMING/ABUSING other people, if any of these occurs then I m not responsible for anything at all
|--------------|
# View it here-
